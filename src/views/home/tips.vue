...
export default defineComponent({
  setup() {
    const noticeList: Array<tipsList> = [
      { title: "3月31日波士顿大学硕士招生宣讲会" },
      { title: "4/16宣讲会——LSE暑期班" },
      { title: "3/7日宣讲会——英国伯明翰大学理工科2+2项目" },
      { title: "3/5日宣讲会——英国CBL牛津剑桥暑期班" },
    ];

    const tipList: Array<tipsList> = [];
    return {
      noticeList,
      tipList,
    };
